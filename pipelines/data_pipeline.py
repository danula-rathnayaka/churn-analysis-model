...
from utils.config import get_data_paths, get_columns, get_outlier_config, get_binning_config, \
...
def data_pipeline(
    ...
    os.makedirs(os.path.join("..", (data_paths['data_artifacts_dir'])), exist_ok=True)
